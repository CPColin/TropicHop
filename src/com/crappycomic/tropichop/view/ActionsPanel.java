...
public class ActionsPanel extends JPanel
{
   ...
   ActionsPanel(final GraphicView view, final ClientModel model)
   {
      ...
      placeFuelStationAction = new AbstractAction("Place Still")
      {
         private static final long serialVersionUID = 0;
      ...
      purchaseFuelStationAction = new AbstractAction("Purchase Still")
      {
         private static final long serialVersionUID = 0;
      ...
      sellFuelStationNormallyAction = new AbstractAction("Sell Still")
      {
         private static final long serialVersionUID = 0;
      ...
      fireLasersAction = new AbstractAction("Fire Lasers")
      {
         ...
         public void actionPerformed(ActionEvent evt)
         {
            Set<Node> targetableNodes = new HashSet<>();
      ...
      sellFuelStationForDebtSettlementAction = new AbstractAction("Sell Still")
      {
         private static final long serialVersionUID = 0;
