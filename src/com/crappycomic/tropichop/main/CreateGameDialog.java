...
import com.crappycomic.tropichop.net.*;
import com.crappycomic.tropichop.view.*;
...
public class CreateGameDialog extends JDialog implements Server.HandshakeObserver
{
   ...
   private class PlayerStateBox extends JComboBox<PlayerState>
   {
   ...
   private JComboBox<ModelXMLLoader.XMLOption> gameBox;
   
   private JComboBox<ModelXMLLoader.XMLOption> ruleSetBox;
   ...
   private boolean start(ServerModel serverModel) throws SAXException, IOException
   {
      ...
      List<Player> players = serverModel == null ? new ArrayList<>() : serverModel.getPlayers();
   ...
   private void addPlayer(ServerModel serverModel, List<Player> players, int ndx, boolean local)
   {
      ...
      {
         server.setPlayers(connection, localPlayers = new HashSet<>());
      }
