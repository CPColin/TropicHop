...
import static com.crappycomic.tropichop.main.CreateGameDialog.*;
...
import com.crappycomic.tropichop.view.PlayerToken;
...
public class AvailablePlayersDialog extends JDialog
{
   ...
   public AvailablePlayersDialog(JDialog owner, Set<Integer> availablePlayers)
   {
      ...
      final JComboBox<Integer> playerBox;
      ...
      hBox.add(playerBox = new JComboBox<>(availablePlayers.toArray(new Integer[0])));
      hBox.add(Box.createHorizontalStrut(GAP));
      ...
      playerBox.setRenderer(new ListCellRenderer<Integer>()
      {
         @Override
            ...
            int index, boolean isSelected, boolean cellHasFocus)
         {
            ...
            if (value != null)
               cell.add(new PlayerToken(value));
