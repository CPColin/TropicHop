...
import com.crappycomic.tropichop.model.Pair;
import com.crappycomic.tropichop.net.*;
import com.crappycomic.tropichop.view.GraphicView;
...
public class JoinGameDialog extends JDialog implements Client.HandshakeObserver
{
   ...
   public void availablePlayers(Set<Integer> availablePlayers)
   {
      ...
      if (player >= 0)
         client.sendObject(new Pair<>(player, availablePlayersDialog.getPlayerName()));
   }
