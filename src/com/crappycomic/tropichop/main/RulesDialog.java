...
import static com.crappycomic.tropichop.main.CreateGameDialog.GAP;
...
import com.crappycomic.tropichop.model.RuleSet;
import com.crappycomic.tropichop.model.RuleSet.*;
...
class RulesDialog extends JDialog
{
   ...
   private static class BooleanRule extends JComboBox<Boolean>
   {
      private BooleanRule(Boolean value)
      {
         super(new Boolean[] {false, true});
         
         setSelectedItem(value);
      }
   }
   
   private static class TransactionAvailabilityRule extends JComboBox<RuleSet.TransactionAvailability>
   {
   ...
   private static class RedShiftRollTypeRule extends JComboBox<RuleSet.RedShiftRoll>
   {
