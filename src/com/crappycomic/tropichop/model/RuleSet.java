...
public class RuleSet implements Serializable
{
   ...
   public static final Rule<Integer> INITIAL_CASH = new Rule<>("initial_cash", RuleType.INTEGER);
   public static final Rule<Integer> INITIAL_FUEL = new Rule<>("initial_fuel", RuleType.INTEGER);
   public static final Rule<Integer> INITIAL_FUEL_STATIONS = new Rule<>("initial_fuel_stations", RuleType.INTEGER);
   public static final Rule<Integer> TOTAL_FUEL_STATIONS = new Rule<>("total_fuel_stations", RuleType.INTEGER);
   public static final Rule<Integer> PASS_START_CASH = new Rule<>("pass_start_cash", RuleType.INTEGER);
   public static final Rule<Integer> LAND_ON_START_CASH = new Rule<>("land_on_start_cash", RuleType.INTEGER);
   public static final Rule<TransactionAvailability> FUEL_STATION_PURCHASE_AVAILABILITY = new Rule<>("fuel_station_purchase_availability", RuleType.TRANSACTION_AVAILABILITY);
   public static final Rule<TransactionAvailability> FUEL_STATION_BUYBACK_AVAILABILITY = new Rule<>("fuel_station_buyback_availability", RuleType.TRANSACTION_AVAILABILITY);
   public static final Rule<Boolean> CAN_PLACE_FUEL_STATIONS_ON_ANY_NODE = new Rule<>("can_place_fuel_stations_on_any_node", RuleType.BOOLEAN);
   public static final Rule<TransactionAvailability> NODE_BUYBACK_AVAILABILITY = new Rule<>("node_buyback_availability", RuleType.TRANSACTION_AVAILABILITY);
   public static final Rule<Integer> FUEL_STATION_PRICE = new Rule<>("fuel_station_price", RuleType.INTEGER);
   public static final Rule<Integer> FUEL_PRICE_ON_START = new Rule<>("fuel_price_on_start", RuleType.INTEGER);
   public static final Rule<Integer> MAXIMUM_FUEL = new Rule<>("maximum_fuel", RuleType.INTEGER);
   public static final Rule<Integer> DIE_PIPS = new Rule<>("die_pips", RuleType.INTEGER);
   public static final Rule<Integer> LOW_FUEL = new Rule<>("low_fuel", RuleType.INTEGER);
   public static final Rule<Integer> MINIMUM_FUEL = new Rule<>("minimum_fuel", RuleType.INTEGER);
   public static final Rule<Boolean> LASER_BATTLES_ALLOWED = new Rule<>("laser_battles_allowed", RuleType.BOOLEAN);
   public static final Rule<Integer> LASER_BATTLE_FUEL_COST = new Rule<>("laser_battle_fuel_cost", RuleType.INTEGER);
   public static final Rule<Integer> LASER_BATTLE_MAXIMUM_DISTANCE = new Rule<>("laser_battle_maximum_distance", RuleType.INTEGER);
   public static final Rule<Integer> LASER_BATTLE_DAMAGE_COST = new Rule<>("laser_battle_damage_cost", RuleType.INTEGER);
   public static final Rule<Boolean> LASERS_CAN_FIRE_FROM_START = new Rule<>("lasers_can_fire_from_start", RuleType.BOOLEAN);
   public static final Rule<Boolean> LASERS_CAN_FIRE_AT_START = new Rule<>("lasers_can_fire_at_start", RuleType.BOOLEAN);
   public static final Rule<RedShiftRoll> RED_SHIFT_ROLL = new Rule<>("red_shift_roll", RuleType.RED_SHIFT_ROLL_TYPE);
   public static final Rule<Boolean> BYPASS_ALLOWED = new Rule<>("bypass_allowed", RuleType.BOOLEAN);
   public static final Rule<Integer> BYPASS_CASH = new Rule<>("bypass_cash", RuleType.INTEGER);
   public static final Rule<Boolean> FUEL_AVAILABLE_ON_UNOWNED_NODE = new Rule<>("fuel_available_on_unowned_node", RuleType.BOOLEAN);
   public static final Rule<Boolean> MUST_REFUEL_AT_DEAD_END = new Rule<>("must_refuel_at_dead_end", RuleType.BOOLEAN);

   private static final Map<String, Rule<?>> RULE_NAME_MAP;
   static
   {
      Map<String, Rule<?>> ruleNameMap = new LinkedHashMap<>();
   ...
   private Map<Rule<?>, Object> ruleValueMap = new LinkedHashMap<>();
