...
public class ModelXMLLoader extends DefaultHandler
{
   ...
   {
      List<XMLOption> options = new ArrayList<>();
   ...
   private Map<Node, List<String>> nodeDestinationIDs = new HashMap<>();
   ...
   private Map<String, Integer> deedGroupCounts = new HashMap<>();
   ...
   public void endElement(String uri, String localName, String name)
   {
      ...
      else if (lastState == State.NODE_DEST)
      {
         ...
         {
            nodeDestinationIDs.put(node, destinations = new ArrayList<>());
         }
   ...
   private void validateConnectivity()
   {
      ...
      Set<Node> unvisitedNodes = new HashSet<>(board.getNodes());
